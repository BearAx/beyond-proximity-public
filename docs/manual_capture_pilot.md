...
Saved report: `docs/dataset_validation/ConferenceHall_capture_pilot_geometry.json`.
...
Saved report: `docs/dataset_validation/ConferenceHall_capture_default_geometry.json`.
...
python -B scripts\validate_scene_geometry.py `
  ...
  --output docs\dataset_validation\ConferenceHall_capture_pilot_geometry.json
```
