---
title: "Reasoning — where is the screen in the conference room"
run: 2026-06-11_1911
case: 1
...
# Case 1: where is the screen in the conference room
...
|-----:|-------------|----------|
| 1 | Decomposition | Parsed query 'where is the screen in the conference room'. Target keywords and room constraints extracted; navigating… |
...
Parsed query 'where is the screen in the conference room'. Target keywords and room constraints extracted; navigating semantic tree instead of scanning all views.
