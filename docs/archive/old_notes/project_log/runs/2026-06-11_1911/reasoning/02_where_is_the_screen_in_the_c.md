---
title: "Reasoning — where is the screen in the conference room located"
run: 2026-06-11_1911
case: 2
graph_verdict: correct_room
flat_verdict: wrong_room
---

[← Run dashboard](../README.md) · [← Docs hub](../../../README.md) · [Benchmark report](../../../../../../benchmarks/benchmark_graph_vs_flat.md)

# Case 2: where is the screen in the conference room located
...
|--|:-------------|:------------|
| **Answer** | `v017` | `v012` |
| **Verdict** | ✅ `correct_room` | ❌ `wrong_room` |
...
|-----:|-------------|----------|
| 1 | Decomposition | Parsed query 'where is the screen in the conference room located'. Target keywords and room constraints extracted; na… |
...
Parsed query 'where is the screen in the conference room located'. Target keywords and room constraints extracted; navigating semantic tree instead of scanning all views.
...
| `v012` | ✓ **STOP** | Scanned v012. First keyword match — STOP. ⚠ WRONG ROOM: matched object is not in the requested zone. |

---

## Takeaway

**Graph wins on room scope.** Flat found an object matching keywords but in the wrong zone. Graph traversal scoped the search to the correct branch of the semantic tree before confirming the view.
