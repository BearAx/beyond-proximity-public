...
└── scripts/run_full_benchmark.py
    ...
    ├── write_project_log()          — project_log/YYYY-MM-DD_HHMM_benchmark.md
    ├── write_docs_hub()             — docs/README.md
    └── write_run_dashboard()        — project_log/runs/{timestamp}/README.md
```
...
========================================================================
  ...
  📋 RUN DASHBOARD (this run — reasoning + charts)
    file:///.../docs/project_log/runs/2026-06-12_1829/README.md

  📊 BENCHMARK REPORT
    file:///.../docs/benchmark_graph_vs_flat.md

  📝 PROJECT LOG
    file:///.../docs/project_log/2026-06-12_1829_benchmark.md
...
| Посмотреть reasoning offline | `./run_all_docs.sh` | `docs/project_log/runs/*/reasoning/` |
...
- [benchmark_graph_vs_flat.md](benchmark_graph_vs_flat.md) — метрики graph vs flat
