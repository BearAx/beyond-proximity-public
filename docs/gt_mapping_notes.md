...
`docs/benchmark_queries_v1.json` is a semantic-index regression benchmark. Expected IDs are valid for testing traversal/output behavior, but its metrics are not independent visual recognition or Replica-GT accuracy.
