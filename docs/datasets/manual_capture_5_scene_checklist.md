...
python -B scripts\check_capture_pilot.py `
  ...
  --output docs\validation\capture_quality\<scene_id>_capture_check.json
```
...
```text
docs/validation/capture_quality/ConferenceHall-capture-pilot_capture_check.json
docs/validation/capture_quality/Museume-capture_capture_check.json
docs/validation/capture_quality/Theater-capture_capture_check.json
docs/validation/capture_quality/outdoor-drone-capture_capture_check.json
docs/validation/capture_quality/outdoor-street-capture_capture_check.json
```
